...
interface EyeIcon extends SVGProps<SVGSVGElement> {
  color?: string;
}
const EyeIcon: FC<EyeIcon> = ({ color = 'white', ...rest }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
